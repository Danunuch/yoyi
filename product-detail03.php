			...
			<div class="container-xxl">
				...
				<div class="row align-items-center" >
					...
					<div class="col-md-6 col-lg-6">
						...
						<h4 >เม็ดไข่มุกสีขาว</h4>


						<p>
						 ไข่มุกสีขาวเป็นสูตรที่ทางบริษัทคิดค้นขึ้นมาเพื่อตอบรับความต้องการของลูกค้า จะมีสีกลิ่นหอม และรสชาติที่เป็นแป้งแบบออริจินอท์ ให้สัมผัสที่นุ่มหนึบ เคี้ยวสนุก น่ารับประทานไม่แพ้สีดำและสีทอง เม็ดแป้งสีขาวนวลเหมือนไข่มุก วัตถุดิบที่นำมาใช้เป็นส่วนประกอบส่วนใหญ่เป็นวัตถุดิบที่บริษัทของเราคัดสรรอย่างดี เพื่อให้สินค้าของเราออกมามีคุณภาพและคุ้มค่าต่อความต้องการของลูกค้า</p>

...
if (isset($_POST['add_detail_cook'])) {
    ...
    $add_detail = $conn->prepare("INSERT INTO cook_detail_en(detail_name, content1, content2, content3, content4, content5, content6, content7,content8,content9,content10,type_id,id) VALUES(:detail_name, :content1, :content2, :content3, :content4, :content5, :content6, :content7, :content8, :content9, :content10, :type_id ,:id)");

...
// Query หลัก
$data_detail = $conn->prepare("SELECT * FROM cook_detail");
$data_detail->execute();
...
if (isset($_POST['delete_all'])) {
    if (count((array)$_POST['ids']) > 0) {
        ...
        if ($del_detail) {
            ...
            echo "<meta http-equiv='refresh' content='1.6;url=cook_detail'>";
        } else {
        ...
        <div id="main">
            ...
            <section class="section">
                <div class="card">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            foreach (array_reverse($row_detail) as $row_detail) { ?>
                                                ...
                                                $select_type = $conn->prepare("SELECT * FROM type_cook WHERE type_id = :type_id");
                                                $select_type->bindParam(':type_id', $row_detail['type_id']);
                                                $select_type->execute();
                                                $query =  $select_type->fetch(PDO::FETCH_ASSOC);


                                                $select_catalog = $conn->prepare("SELECT * FROM catalog_cook WHERE id = :id");
                    ...
                    $select_stmt = $conn->prepare("SELECT * FROM catalog_cook");
                    $select_stmt->execute();
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <?php
                                                $stmt1 = $conn->prepare("SELECT* FROM type_cook");
                                                $stmt1->execute();

...
if (isset($_POST['del-img'])) {
    ...
    if ($delete_img) {
        echo "<meta http-equiv='refresh' content='0;url=product_en?product_id=$id_product'>";
    }
}
                            ...
                            <div class="mt-4">
                                ...
                                <ul class="pagination justify-content-center mt-5">
                                    <li <?php if ($page == 1) {
                                        ...
                                        <a class="page-link" href="product_en?page=<?php echo $page - 1 ?>" tabindex="-1" aria-disabled="true"><span class="material-icons"></span>ก่อนหน้า</a>
                                    </li>
                                    ...
                                    for ($i = 1; $i <= $total_page; $i++) { ?>
                                        <li <?php if ($page == $i) {
                                            ...
                                            } ?>><a class="page-link" href="product_en?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                                    <?php   }
                                    ?>
                                    ...
                                    <li <?php if ($page == $total_page) {
                                        ...
                                        <a class="page-link" href="product_en?page=<?php echo $page + 1 ?>">ถัดไป <span class="material-icons"></span></a>
                                    </li>
                                </ul>
                            </div>

			...
			<div class="container-xxl">
				...
				<div class="row align-items-center" >
					...
					<div class="col-md-6 col-lg-6">
						...
						<h4 >เม็ดไข่มุกสีดำ</h4>


						<p>
						สามารถพบเห็นได้ทั่วไปตามร้านชานมไข่มุก ซึ่งเป็นสีที่หาทานง่ายที่สุด และคนไทยคุ้นเคยเป็นอย่างมาก รสชาติ รสสัมผัสคิดค้นสูตรต้นตำหรับจากจากไต้หวัน 100 % กลิ่นหอมบราวน์ชูการ์ที่เป็นเอกลักษณ์ ความนุ่มหนึบของเม็ดไข่มุก อีกทั้งวัตถุดิบที่นำมาใช้เป็นส่วนประกอบส่วนใหญ่เป็นวัตถุดิบอย่างดีที่นำเข้าจากต่างประเทศทั้งสิ้น</p>
